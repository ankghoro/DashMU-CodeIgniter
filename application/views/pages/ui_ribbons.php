					...
					<div class="row mt-4">
						<div class="col-sm-4">
							<div class="position-relative">
								<img src="<?php echo base_url(); ?>assets/images/m2-chip-white.jpeg" alt="Photo 1" class="img-fluid">
								<div class="ribbon-wrapper ribbon-lg">
									<div class="ribbon bg-success text-lg">
										Ribbon
									</div>
						...
						<div class="col-sm-4">
							<div class="position-relative">
								<img src="<?php echo base_url(); ?>assets/images/m2-chip-white.jpeg" alt="Photo 2" class="img-fluid">
								<div class="ribbon-wrapper ribbon-xl">
									<div class="ribbon bg-warning text-lg">
										Ribbon
									</div>
						...
						<div class="col-sm-4">
							<div class="position-relative" style="min-height: 180px;">
								<img src="<?php echo base_url(); ?>assets/images/m2-chip-white.jpeg" alt="Photo 3" class="img-fluid">
								<div class="ribbon-wrapper ribbon-xl">
									<div class="ribbon bg-danger text-xl">
										Ribbon
									</div>
